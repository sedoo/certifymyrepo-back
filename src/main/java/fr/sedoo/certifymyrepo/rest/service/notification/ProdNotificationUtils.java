...
public class ProdNotificationUtils implements NotificationUtils {
	
	Logger logger = LoggerFactory.getLogger(ProdNotificationUtils.class);
	...
	private void buildReminderNotification(String reportName, String repositoryId, String subject, 
		...
		for(String userId : repoUserIdList) {
			Optional<fr.sedoo.certifymyrepo.rest.domain.Profile> userProfile = profileDao.findById(userId);
